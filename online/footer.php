...
<footer id="footer" class="section section-grey">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<div class="footer-logo">
						<a class="logo" href="#">
							<img src="../public/images/logo/logo-arvene-ver.png" alt="">
						</a>
					</div>
					<!-- /footer logo -->
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					<h3 class="footer-header">Selengkapnya</h3>
					<ul class="list-links">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					<h3 class="footer-header">Petunjuk Pengunaan</h3>
					...
					<ul class="footer-social">
						...
						<li><a href="https://www.instagram.com/rosenita_florist/?hl=id"><i class="fa fa-instagram"></i></a></li>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					<h3 class="footer-header">Alamat</h3>
					
					<p>Jl. Ahmad Jazuli, Kotabaru, Kec.Gondokusuman, Kota Yogyakarta, Daerah Istimewa Yogyakarta 5524</p>
