...
<footer>
    <div class="container">
        <div class="footer">
            ...
            <div class="socials">
                <ul class="menu">
                    ...
                    <li class="social-item">
                        <a class="social-link" href="https://instagram.com/batikgems?igshid=OGQ5ZDc2ODk2ZA==" target="_blank">instagram</a>
                    </li>
                </ul>
            </div>
        ...
        <p class="all-rights">© 2023 BatikGems. All rights reserved</p>
    </div>
</footer>